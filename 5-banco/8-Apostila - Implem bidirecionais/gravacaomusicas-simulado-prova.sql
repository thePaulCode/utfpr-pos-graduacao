...
INSERT INTO pessoa(cod_pessoa, nome_pessoa) VALUES (1, 'Paul San');
INSERT INTO pessoa(cod_pessoa, nome_pessoa) VALUES (2, 'Kroos Strauss');
INSERT INTO pessoa(cod_pessoa, nome_pessoa) VALUES (3, 'Olavo San');
INSERT INTO pessoa(cod_pessoa, nome_pessoa) VALUES (4, 'Doni San');
INSERT INTO pessoa(cod_pessoa, nome_pessoa) VALUES (5, 'Weber San');
INSERT INTO pessoa(cod_pessoa, nome_pessoa) VALUES (6, 'Anna San');
INSERT INTO pessoa(cod_pessoa, nome_pessoa) VALUES (7, 'Stll San');
INSERT INTO pessoa(cod_pessoa, nome_pessoa) VALUES (8, 'Albert San');
INSERT INTO pessoa(cod_pessoa, nome_pessoa) VALUES (9, 'Evaristo San');
INSERT INTO pessoa(cod_pessoa, nome_pessoa) VALUES (10, 'Joseph San');

INSERT INTO fone(cod_fone, numero, tipo, cod_pessoa) VALUES (1, '1111-2222', 'R', 1);
INSERT INTO fone(cod_fone, numero, tipo, cod_pessoa) VALUES (2, '3333-2222', 'C', 1);
INSERT INTO fone(cod_fone, numero, tipo, cod_pessoa) VALUES (3, '5555-2222', 'M', 1);
INSERT INTO fone(cod_fone, numero, tipo, cod_pessoa) VALUES (4, '1111-0222', 'R', 2);
INSERT INTO fone(cod_fone, numero, tipo, cod_pessoa) VALUES (5, '3333-0222', 'C', 2);
INSERT INTO fone(cod_fone, numero, tipo, cod_pessoa) VALUES (6, '5555-0222', 'M', 2);
INSERT INTO fone(cod_fone, numero, tipo, cod_pessoa) VALUES (7, '1111-9222', 'R', 3);
INSERT INTO fone(cod_fone, numero, tipo, cod_pessoa) VALUES (8, '3333-9222', 'C', 3);
INSERT INTO fone(cod_fone, numero, tipo, cod_pessoa) VALUES (9, '5555-9222', 'M', 3);
...
SELECT p.nome_pessoa, f.numero 
from pessoa p
JOIN fone f WHERE f.cod_pessoa = p.cod_pessoa and f.tipo like 'C';
