    ...
    <Row>
      <Col md="8">
        <h2 data-cy="locationDetailsHeading">
          <Translate contentKey="app1App.location.detail.title">Location</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="city">
              <Translate contentKey="app1App.location.city">City</Translate>
            </span>
          </dt>
          ...
          <dt>
            <Translate contentKey="app1App.location.country">Country</Translate>
          </dt>
