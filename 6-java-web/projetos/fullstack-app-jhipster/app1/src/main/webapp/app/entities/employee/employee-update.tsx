  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="app1App.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="app1App.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('app1App.employee.firstName')}
              ...
              <ValidatedField
                label={translate('app1App.employee.lastName')}
                id="employee-lastName"
                name="lastName"
                data-cy="lastName"
                type="text"
              />
              <ValidatedField label={translate('app1App.employee.email')} id="employee-email" name="email" data-cy="email" type="text" />
              <ValidatedField
                label={translate('app1App.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('app1App.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('app1App.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('app1App.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('app1App.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('app1App.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
