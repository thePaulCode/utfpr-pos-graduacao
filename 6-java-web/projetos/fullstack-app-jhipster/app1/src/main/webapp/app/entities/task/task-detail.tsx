    ...
    <Row>
      <Col md="8">
        <h2 data-cy="taskDetailsHeading">
          <Translate contentKey="app1App.task.detail.title">Task</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="title">
              <Translate contentKey="app1App.task.title">Title</Translate>
            </span>
          </dt>
          ...
          <dt>
            <Translate contentKey="app1App.task.job">Job</Translate>
          </dt>
          <dd>
            {taskEntity.jobs
