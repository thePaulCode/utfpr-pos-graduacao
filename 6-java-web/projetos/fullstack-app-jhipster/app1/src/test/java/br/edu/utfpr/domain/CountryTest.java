...
import static br.edu.utfpr.domain.CountryTestSamples.*;
import static br.edu.utfpr.domain.LocationTestSamples.*;
import static br.edu.utfpr.domain.RegionTestSamples.*;
